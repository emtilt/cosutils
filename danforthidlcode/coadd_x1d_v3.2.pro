...
;; 16384 = 2^14 = Not used                   --> ignore   
    ...
    bad = [waveintmp[aa[bb[0]-1]], waveintmp[aa[bb[-1]]]]
...
ENDIF ELSE BEGIN
   ...
   if lsfsave then dateobs   = [dateobs,dateobs]
   fppos     = [fppos,fppos]
   scale     = [scale,scale]
...
if lsfsave then begin
  ...
  juldateobs=julday(strmid(dateobs,5,2),strmid(dateobs,8,2),strmid(dateobs,0,4),0)
