...
;;   fcx    - fraction of line profile contained within xopt
;;
;; CDanforth 12/30/11
;; B. Keeney 02/16/12
;; B. Keeney 01/07/14
...
function cos_siglevel, w, lambda, b, snpix=snpix, snx=snx, $
                       disp=disp, bin=bin, xopt=xopt, fcx=fcx
